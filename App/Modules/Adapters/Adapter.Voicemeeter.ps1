# ==========================================
# SAMISH Device Adapter: Voicemeeter
# ==========================================

function Stop-VoicemeeterAdapter {
    param(
        [string]$ProcessName,
...
function Start-VoicemeeterAdapter {
    param(
        [string]$ProcessName,
        [string]$ConfiguredPath
    )
    ...
    $lookup = Get-AppExecutablePath -ProcessName $ProcessName -ConfiguredPath $ConfiguredPath -RegistrySearchString "Voicemeeter"
