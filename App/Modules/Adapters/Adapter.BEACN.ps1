# ==========================================
# SAMISH Device Adapter: BEACN
# ==========================================

function Stop-BEACNAdapter {
    param(
        [string]$ProcessName,
...
function Start-BEACNAdapter {
    ...
    # Note: BEACN specifically uses "BEACN" in its registry uninstall key
    $lookup = Get-AppExecutablePath -ProcessName $ProcessName -ConfiguredPath $ConfiguredPath -RegistrySearchString "BEACN"
