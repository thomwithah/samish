# ==========================================
# SAMISH Device Adapter: GoXLR
# ==========================================

function Stop-GoXLRAdapter {
    param(
        [string]$ProcessName,
...
function Start-GoXLRAdapter {
    ...
    $lookup = Get-AppExecutablePath -ProcessName $ProcessName -ConfiguredPath $ConfiguredPath -RegistrySearchString "GoXLR"
